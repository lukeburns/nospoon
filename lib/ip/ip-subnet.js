...
/**
 * First unused 10.0.n.1 in 10.0.0.0/16 (private LAN convention). Returns that host as `/24` and
 * `peerAlias` `10.0.n.2` in the same subnet for callers that need a second fixed slot.
