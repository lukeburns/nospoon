...
async function startClient ({ key, ip = '10.0.0.1/24', ipv6, seed, mtu = 1400, fullTunnel, peerIp = '10.0.0.2' }) {
  ...
  function connect () {
    ...
    connection.on('open', function () {
      ...
      function applyHubDirectory (json) {
        ...
        if (n > 0) {
          console.log(`Hub directory: registered ${n} peer key(s) for spoke-to-spoke`)
        }
      }
