 ...
 * @param {{ dhtClientMode?: boolean, extraListenIpv4?: string[] }} [heliaOpts] forwarded to `createHeliaBackend` in the worker
 * @returns {Promise<{ stop: function(): Promise<void>, resolveContent: function(object): Promise<object>, listPins: function(): Promise<Array<{ cid: string, filename: string | null }>>, listSeeds: function(): Promise<Array<{ cid: string, filename: string | null }>>, unpin: function(string): Promise<void>, unseed: function(string): Promise<void>, addFileFromPath: function(object): Promise<string>, addDirectory: function(Array): Promise<{ cid: string, filename: string }>, libp2pStatus: function(): Promise<object>, initialHeliaLibp2p: object | null, helia: null }>}
 */
async function createHeliaWorkerBackend (dataDir, heliaOpts) {
  ...
  return {
    ...
    addDirectory: function (entries) {
      return rpc('addDirectory', { entries })
    },
