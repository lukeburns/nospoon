...
/**
 * Logical mesh identity for DNS / routing. Key-address wire slots carry 32-byte endpoint ids
 * (BLAKE2b over domain + Ed25519 public key + topic preimage); see `endpointPublicId` in key-address.js.
 *
 * @typedef {{ kind: 'key', keyHex: string } | { kind: 'keyTopic', keyHex: string, topicId: string, topicBytes?: Buffer }} MeshIdentifier
 */
