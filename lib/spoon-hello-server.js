 ...
 * signed line with local and remote wire identities (includes ISO 8601 timestamp in the signed text).
  ...
  function onRequest (req, res) {
    ...
    Promise.resolve()
      ...
      .then(function (visitorLine) {
        ...
        const bodyLine = `greetings ${yourKey}. signed, ${myPublicKeyZ32} @ ${ts}`
