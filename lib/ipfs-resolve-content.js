...
async function createHeliaBackend (dataDir, heliaOpts) {
  ...
  /** @type {Map<string, { mas: import('@multiformats/multiaddr').Multiaddr[], learnedPeerId: string | null }>} */
  ...
  /**
   * @param {{ mas: import('@multiformats/multiaddr').Multiaddr[], learnedPeerId: string | null }} row
   */
   ...
   * @returns {{ targets: Array<{ targetKey: string, meshIpv4: string, port: number, learnedPeerId: string | null }> }}
   */
  function meshHeliaDialStatus () {
    /** @type {Array<{ targetKey: string, meshIpv4: string, port: number, learnedPeerId: string | null }>} */
    const targets = []
