 ...
 * @param {number} port
 * @param {{ dhtClientMode?: boolean, upnpAutoConfirmAddress?: boolean, appendAnnounce?: string[], announceNoCircuit?: boolean }} [opts]
 ...
 * }} [heliaOpts] — `dhtClientMode` from control UI when set; otherwise `NOSPOON_HELIA_DHT_CLIENT_MODE`. UPnP and append-announce default from env.
