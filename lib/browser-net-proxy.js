 ...
 * @param {function(string, import('ws')): string | null} [opts.resolveDns]
 */
  ...
  return createBrowserNetMiddleware({
    ...
    getOutboundRoute:
      typeof opts.getOutboundRoute === 'function'
        ...
        : undefined,
    resolveDns:
      typeof opts.resolveDns === 'function'
        ? function (hostname, ws) {
          return opts.resolveDns(hostname, ws)
        }
        : undefined,
    reverseDns:
      typeof opts.reverseDns === 'function'
        ? function (ip, ws) {
          return opts.reverseDns(ip, ws)
        }
        : undefined,
