 ...
 *   const { shutdown } = nospoon.createClient({ key: '<server-hex>', dht: sharedDht }) // programmatic client (TUN + routing); pass `cli: true` or use startClient for the CLI behavior
