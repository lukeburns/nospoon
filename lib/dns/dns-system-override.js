...
/**
 * @param {{ dnsServers?: string[] }} [opts] — from control plane: session upstream first, then pre-override OS resolvers merged (deduped); omit to restore pre-apply snapshot (tests / legacy).
 */
function restore (opts) {
  return getImpl().restore(opts)
}
