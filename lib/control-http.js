...
class ControlPlaneSessionManager extends EventEmitter {
  ...
  // TODO: Improve handling when the same remote is reachable via multiple interfaces (primary direct
  // pool and/or one or more topic TUNs): path selection, deduped streams, and status/UI consistency.
